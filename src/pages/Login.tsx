      ...
      <div className="hidden lg:flex lg:w-[45%] bg-white flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center gap-7">
          ...
          <h2 className="text-5xl text-[#0a2630] font-semibold text-tct-darker">
            Welcome to<br />Explore the beauty
          </h2>
          <p className="text-md text-gray-500 leading-relaxed max-w-[360px] font-light">
            Discover, plan, and experience unforgettable travel adventures crafted just for you.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center px-12 py-12 bg-[#0a2630] relative overflow-hidden">
        ...
        <div className="w-full max-w-[400px] relative z-10">
          ...
          <div className="mb-11">
            ...
            <p className="text-sm text-[#6b8c97] font-light">Sign in to continue your adventure</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="text-[11px] font-medium tracking-[0.08em] uppercase text-[#6b8c97]">
                  Password
                </label>
                <Link to="/forgot-password" className="text-[12px] text-[#5fa8b8] font-normal">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-[18px] py-3.5 bg-white/[0.04] border border-white/[0.09] rounded-[10px] text-white text-sm placeholder-white/20 outline-none focus:border-white/20 focus:bg-white/[0.06] transition-all duration-200 pr-11"
                  required
                />
                <button
                  type="button"
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="remember" className="text-[13px] text-[#6b8c97] font-light cursor-pointer">
                Remember me
              </label>
            </div>
          ...
          <p className="text-center text-[13px] text-white/30">
            ...
            <Link to="/register" className="text-[#5fa8b8] font-medium">
              Create one
            </Link>
          </p>
        </div>
