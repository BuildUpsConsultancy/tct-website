          ...
          >
            ...
            <div className="relative w-full p-12 sm:p-16 bg-transparent overflow-visible font-sans h-full min-h-[550px] lg:min-h-0">
              ...
              >
                ...
                <div className="absolute -top-16 -left-10 w-44 sm:w-56 md:w-64 bg-white p-2.5 pb-6 sm:p-3 sm:pb-8 shadow-2xl border border-gray-200 transform -rotate-12 transition-transform hover:rotate-0 hover:z-50 duration-300 mobile-float-1">
                  <img
                ...
                <div className="absolute -top-16 -right-10 w-44 sm:w-56 md:w-64 bg-white p-2.5 pb-6 sm:p-3 sm:pb-8 shadow-2xl border border-gray-200 transform rotate-12 z-20 transition-transform hover:rotate-0 hover:z-50 duration-300 mobile-float-2">
                  <img
                ...
                <div className="absolute top-1/4 -left-6 sm:-left-10 w-48 sm:w-60 md:w-68 bg-white p-2.5 pb-8 sm:p-3 sm:pb-10 shadow-2xl border border-gray-100 transform -rotate-3 z-10 transition-transform hover:rotate-0 hover:z-50 duration-300 mobile-float-3">
                  <img
                ...
                <div className="absolute -bottom-16 -left-10 w-48 sm:w-60 md:w-68 bg-white p-2.5 pb-6 sm:p-3 sm:pb-8 shadow-2xl border border-gray-200 transform -rotate-6 z-20 transition-transform hover:rotate-0 hover:z-50 duration-300 mobile-float-4">
                  <img
                ...
                <div className="absolute -bottom-16 -right-10 w-48 sm:w-60 md:w-68 bg-white p-2.5 pb-6 sm:p-3 sm:pb-8 shadow-2xl border border-gray-200 transform rotate-6 z-20 transition-transform duration-300 ease-out hover:rotate-0 hover:z-50 mobile-float-5">
                  <img
